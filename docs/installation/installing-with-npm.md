...
To use NHS.Wales frontend in your projects with npm you must:
...
Install the NHS.Wales frontend package into your project:
...
You will need to import a couple of things into your project before you can start using NHS.Wales frontend:
...
You need to import the NHS.Wales frontend styles into the main Sass file in your project. You should place the below code before your own Sass rules (or Sass imports).
...
You should include NHS.Wales frontend JavaScript in your project to ensure that all users can use it successfully.
...
<link rel="mask-icon" href="path-to-assets/favicon.svg" color="#2C3E72">
