...
BackstopJS tests configuration and files can be found within the `backstop` folder in the [tests directory](https://github.com/nwisbeta/nhswales-frontend/tree/master/tests).
