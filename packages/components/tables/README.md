...
[Preview the table component](https://nwibeta.github.io/nhswales-frontend/components/tables/index.html)
...
[Preview the table panel component](https://nwibeta.github.io/nhswales-frontend/components/tables/tables-panel.html)
...
[Preview the responsive table component](https://nwibeta.github.io/nhswales-frontend/components/tables/responsive-table.html)
...
| **panel**              | boolean    | No        | If set to true, the table is rendered inside a [panel with a label](https://nwibeta.github.io/nhswales-frontend/components/panel-with-label.html). |
